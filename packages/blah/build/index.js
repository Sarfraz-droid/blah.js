...
class $14ac4dfe2bd0d117$export$4b76bf9bf7e9bb7e {
        ...
        for(let i = 0; i < attributes.length; i++){
            ...
            if (attribName.startsWith("@")) {
                ...
                element.addEventListener(eventName, (e)=>{
                    ...
                    if (value instanceof (0, $14ac4dfe2bd0d117$export$4b76bf9bf7e9bb7e)) {
        ...
        return $a32bf89f10f59818$var$__awaiter(this, void 0, void 0, function*() {
            ...
            switch(nodeName){
                case $a32bf89f10f59818$var$NodeType.TEMPLATE:
                    yield (0, $6ff1c4ed1526c2ce$exports.CustomElement).Template(blah, dom.getAttribute("src"), dom);
                    break;
                default:
                    break;
            }
...
class $730fd1ef0151d5f5$export$8210dfe1863c478 {
    ...
    createHook(func, variableName) {
        const state = new (0, $14ac4dfe2bd0d117$export$4b76bf9bf7e9bb7e)(func, this.root, variableName);
        return state;
    }
}
...
class $fe673acc26d28f6f$export$8ba59ee53d0339a0 {
    constructor(){
        this.dom = new (0, $9de9dced5e589ab7$export$657f8094468310ff)(this);
